...
LRESULT MainWindowPageStats::MainWindowPageProc(UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch(uMsg) {
        ...
        case WM_WINDOWPOSCHANGED:
            ...
            ::SetWindowPos(hWndPageItems[BTN_START_STOP], NULL, 0, 0, iX-10, 20, SWP_NOMOVE | SWP_NOZORDER);
            ...
            ::SetWindowPos(hWndPageItems[BTN_REDIRECT_ALL], NULL, 0, 0, iX-10, 20, SWP_NOMOVE | SWP_NOZORDER);
            ::SetWindowPos(hWndPageItems[BTN_MASS_MSG], NULL, 0, 0, iX-10, 20, SWP_NOMOVE | SWP_NOZORDER);
...
bool MainWindowPageStats::CreateMainWindowPage(HWND hOwner) {
    ...
    hWndPageItems[BTN_START_STOP] = ::CreateWindowEx(0, WC_BUTTON, bServerRunning == false ? LanguageManager->sTexts[LAN_START_HUB] : LanguageManager->sTexts[LAN_STOP_HUB],
        WS_CHILD | WS_VISIBLE | WS_TABSTOP | BS_PUSHBUTTON, 5, 4, rcMain.right-10, 20, m_hWnd, (HMENU)BTN_START_STOP, g_hInstance, NULL);

    hWndPageItems[GB_STATS] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_BUTTON, "", WS_CHILD | WS_VISIBLE | BS_GROUPBOX,
        6, 23, rcMain.right-12, 138, m_hWnd, NULL, g_hInstance, NULL);
    ...
    hWndPageItems[BTN_REDIRECT_ALL] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_REDIRECT_ALL_USERS], WS_CHILD | WS_VISIBLE | WS_DISABLED |
        WS_TABSTOP | BS_PUSHBUTTON, 5, 166, rcMain.right-10, 20, m_hWnd, (HMENU)BTN_REDIRECT_ALL,
        g_hInstance, NULL);

    hWndPageItems[BTN_MASS_MSG] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_MASS_MSG], WS_CHILD | WS_VISIBLE | WS_DISABLED | WS_TABSTOP |
        BS_PUSHBUTTON, 5, 190, rcMain.right-10, 20, m_hWnd, (HMENU)BTN_MASS_MSG, g_hInstance, NULL);
