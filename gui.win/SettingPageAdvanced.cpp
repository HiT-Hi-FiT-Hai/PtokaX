...
bool SettingPageAdvanced::CreateSettingPage(HWND hOwner) {
    ...
    hWndPageItems[GB_HUB_STARTUP_AND_TRAY] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_BUTTON, LanguageManager->sTexts[LAN_HUB_STARTUP_AND_TRAY_ICON],
        WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | BS_GROUPBOX, 0, 0, 447, 90, m_hWnd, NULL, g_hInstance, NULL);

    hWndPageItems[BTN_AUTO_START] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_HUB_AUTO_START], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        7, 15, 433, 16, m_hWnd, NULL, g_hInstance, NULL);
    ...
    hWndPageItems[BTN_CHECK_FOR_UPDATE] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_UPDATE_CHECK_ON_STARTUP], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
    ...
    hWndPageItems[BTN_ENABLE_TRAY_ICON] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_ENABLE_TRAY_ICON], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        7, 51, 433, 16, m_hWnd, (HMENU)BTN_ENABLE_TRAY_ICON, g_hInstance, NULL);
    ...
    hWndPageItems[BTN_MINIMIZE_ON_STARTUP] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_MINIMIZE_ON_STARTUP], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        7, 69, 433, 16, m_hWnd, NULL, g_hInstance, NULL);
    ...
    hWndPageItems[GB_HUB_COMMANDS] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_BUTTON, LanguageManager->sTexts[LAN_HUB_COMMANDS], WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS |
        WS_CLIPCHILDREN | BS_GROUPBOX, 0, 90, 447, 58, m_hWnd, NULL, g_hInstance, NULL);
    ...
    hWndPageItems[LBL_PREFIXES_FOR_HUB_COMMANDS] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_STATIC, LanguageManager->sTexts[LAN_PREFIXES_FOR_HUB_CMDS],
        WS_CHILD | WS_VISIBLE | SS_LEFT, 7, 107, 362, 16, m_hWnd, NULL, g_hInstance, NULL);

    hWndPageItems[EDT_PREFIXES_FOR_HUB_COMMANDS] = ::CreateWindowEx(WS_EX_CLIENTEDGE | WS_EX_TRANSPARENT, WC_EDIT, SettingManager->sTexts[SETTXT_CHAT_COMMANDS_PREFIXES],
        WS_CHILD | WS_VISIBLE | ES_AUTOHSCROLL, 374, 105, 66, 18, m_hWnd, (HMENU)EDT_PREFIXES_FOR_HUB_COMMANDS, g_hInstance, NULL);
    ::SendMessage(hWndPageItems[EDT_PREFIXES_FOR_HUB_COMMANDS], EM_SETLIMITTEXT, 5, 0);

    hWndPageItems[BTN_REPLY_TO_HUB_COMMANDS_IN_PM] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_REPLY_HUB_CMDS_PM], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        7, 127, 433, 16, m_hWnd, NULL, g_hInstance, NULL);
    ...
    hWndPageItems[GB_SCRIPTING] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_BUTTON, LanguageManager->sTexts[LAN_SCRIPTING],
        WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | BS_GROUPBOX, 0, 148, 447, 90, m_hWnd, NULL, g_hInstance, NULL);

    hWndPageItems[BTN_ENABLE_SCRIPTING] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_ENABLE_SCRIPTING], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        7, 163, 433, 16, m_hWnd, (HMENU)BTN_ENABLE_SCRIPTING, g_hInstance, NULL);
    ...
    hWndPageItems[BTN_STOP_SCRIPT_ON_ERROR] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_STOP_SCRIPT_ON_ERR], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        7, 181, 433, 16, m_hWnd, NULL, g_hInstance, NULL);
    ...
    hWndPageItems[BTN_POPUP_SCRIPT_WINDOW_ON_ERROR] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_POPUP_SCRIPT_WINDOW], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        7, 199, 433, 16, m_hWnd, NULL, g_hInstance, NULL);
    ...
    hWndPageItems[BTN_SAVE_SCRIPT_ERRORS_TO_LOG] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_LOG_SCRIPT_ERRORS], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
    ...
    hWndPageItems[GB_KICK_MESSAGES] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_BUTTON, LanguageManager->sTexts[LAN_KICK_MESSAGES],
        WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | BS_GROUPBOX, 0, 238, 447, 54, m_hWnd, NULL, g_hInstance, NULL);

    hWndPageItems[BTN_FILTER_KICK_MESSAGES] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_FILTER_KICKS], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        7, 253, 433, 16, m_hWnd, (HMENU)BTN_FILTER_KICK_MESSAGES, g_hInstance, NULL);
    ...
    hWndPageItems[BTN_SEND_KICK_MESSAGES_TO_OPS] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_FILTERED_KICKS_TO_OPS], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        7, 271, 433, 16, m_hWnd, NULL, g_hInstance, NULL);
    ...
    hWndPageItems[GB_STATUS_MESSAGES] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_BUTTON, LanguageManager->sTexts[LAN_STATUS_MESSAGES],
        WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | BS_GROUPBOX, 0, 292, 447, 54, m_hWnd, NULL, g_hInstance, NULL);

    hWndPageItems[BTN_SEND_STATUS_MESSAGES_TO_OPS] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_SEND_STATUS], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        7, 307, 433, 16, m_hWnd, (HMENU)BTN_SEND_STATUS_MESSAGES_TO_OPS, g_hInstance, NULL);
    ...
    hWndPageItems[BTN_SEND_STATUS_MESSAGES_IN_PM] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_SEND_STATUS_PM], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        7, 325, 433, 16, m_hWnd, NULL, g_hInstance, NULL);
    ...
    hWndPageItems[GB_PINGER] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_BUTTON, LanguageManager->sTexts[LAN_PINGER],
        WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | BS_GROUPBOX, 0, 346, 447, 54, m_hWnd, NULL, g_hInstance, NULL);

    hWndPageItems[BTN_DISALLOW_PINGER] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_DISALLOW_PINGERS], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        7, 361, 433, 16, m_hWnd, (HMENU)BTN_DISALLOW_PINGER, g_hInstance, NULL);
    ...
    hWndPageItems[BTN_REPORT_PINGER] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_REPORT_PINGERS], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        7, 379, 433, 16, m_hWnd, NULL, g_hInstance, NULL);
