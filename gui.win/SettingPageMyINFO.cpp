...
bool SettingPageMyINFO::CreateSettingPage(HWND hOwner) {
    ...
    hWndPageItems[GB_MYINFO_PROCESSING] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_BUTTON, LanguageManager->sTexts[LAN_MYINFO_PROCESSING], WS_CHILD |
        WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | BS_GROUPBOX, 0, 0, 447, 195, m_hWnd, NULL, g_hInstance, NULL);

    hWndPageItems[LBL_MINUTES_BEFORE_ACCEPT_NEW_MYINFO] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_STATIC, LanguageManager->sTexts[LAN_MYINFO_DELAY],
        WS_CHILD | WS_VISIBLE | SS_LEFT, 7, 19, 297, 16, m_hWnd, NULL, g_hInstance, NULL);

    hWndPageItems[EDT_MINUTES_BEFORE_ACCEPT_NEW_MYINFO] = ::CreateWindowEx(WS_EX_CLIENTEDGE | WS_EX_TRANSPARENT, WC_EDIT, "", WS_CHILD | WS_VISIBLE |
        ES_NUMBER | ES_AUTOHSCROLL | ES_RIGHT, 309, 15, 109, 20, m_hWnd, (HMENU)EDT_MINUTES_BEFORE_ACCEPT_NEW_MYINFO, g_hInstance, NULL);
    ::SendMessage(hWndPageItems[EDT_MINUTES_BEFORE_ACCEPT_NEW_MYINFO], EM_SETLIMITTEXT, 5, 0);

    AddUpDown(hWndPageItems[UD_MINUTES_BEFORE_ACCEPT_NEW_MYINFO], 418, 15, 14, 20, (LPARAM)MAKELONG(999, 0), (WPARAM)hWndPageItems[EDT_MINUTES_BEFORE_ACCEPT_NEW_MYINFO],
        (LPARAM)MAKELONG(SettingManager->iShorts[SETSHORT_MYINFO_DELAY], 0));

    hWndPageItems[LBL_ORIGINAL_MYINFO] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_STATIC, LanguageManager->sTexts[LAN_ORIGINAL_MYINFO],
        WS_CHILD | WS_VISIBLE | SS_LEFT, 7, 44, 140, 16, m_hWnd, NULL, g_hInstance, NULL);

    hWndPageItems[CB_ORIGINAL_MYINFO_ACTION] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_COMBOBOX, "", WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS |
        WS_CLIPCHILDREN | WS_VSCROLL | CBS_DROPDOWNLIST, 152, 40, 290, 20, m_hWnd, (HMENU)CB_ORIGINAL_MYINFO_ACTION, g_hInstance, NULL);
    ...
    hWndPageItems[GB_MODIFIED_MYINFO_OPTIONS] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_BUTTON, LanguageManager->sTexts[LAN_OPTIONS_FOR_MODIFIED_MYINFO], WS_CHILD |
        WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | BS_GROUPBOX, 5, 62, 437, 126, m_hWnd, NULL, g_hInstance, NULL);

    hWndPageItems[BTN_REMOVE_DESCRIPTION] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_REMOVE_DESCRIPTION], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        12, 77, 423, 16, m_hWnd, NULL, g_hInstance, NULL);
    ...
    hWndPageItems[BTN_REMOVE_TAG] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_REMOVE_TAG], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        12, 95, 423, 16, m_hWnd, NULL, g_hInstance, NULL);
    ...
    hWndPageItems[BTN_REMOVE_CONNECTION] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_REMOVE_CONNECTION], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        12, 113, 423, 16, m_hWnd, NULL, g_hInstance, NULL);
    ...
    hWndPageItems[BTN_REMOVE_EMAIL] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_REMOVE_EMAIL], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        12, 131, 423, 16, m_hWnd, NULL, g_hInstance, NULL);
    ...
    hWndPageItems[BTN_MODE_TO_MYINFO] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_MODE_TO_MYINFO], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        12, 149, 423, 16, m_hWnd, NULL, g_hInstance, NULL);
    ...
    hWndPageItems[BTN_MODE_TO_DESCRIPTION] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_MODE_TO_DESCR], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        12, 167, 423, 16, m_hWnd, NULL, g_hInstance, NULL);
    ...
    hWndPageItems[GB_DESCRIPTION_TAG] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_BUTTON, LanguageManager->sTexts[LAN_DESCRIPTION_TAG], WS_CHILD |
        WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | BS_GROUPBOX, 0, 195, 447, 181, m_hWnd, NULL, g_hInstance, NULL);

    hWndPageItems[BTN_ACCEPT_UNKNOWN] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_ACCEPT_UNKNOWN_TAG], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        7, 210, 433, 16, m_hWnd, NULL, g_hInstance, NULL);
    ...
    hWndPageItems[GB_NO_TAG_ACTION] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_BUTTON, LanguageManager->sTexts[LAN_NO_TAG_ACTION], WS_CHILD |
        WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | BS_GROUPBOX, 5, 227, 437, 124, m_hWnd, NULL, g_hInstance, NULL);

    hWndPageItems[CB_NO_TAG_ACTION] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_COMBOBOX, "", WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS |
        WS_CLIPCHILDREN | WS_VSCROLL | CBS_DROPDOWNLIST, 10, 242, 427, 20, m_hWnd, (HMENU)CB_NO_TAG_ACTION, g_hInstance, NULL);
    ...
    hWndPageItems[GB_NO_TAG_MESSAGE] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_BUTTON, LanguageManager->sTexts[LAN_MSG_TO_SND], WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS |
        WS_CLIPCHILDREN | BS_GROUPBOX, 10, 264, 427, 40, m_hWnd, NULL, g_hInstance, NULL);

    hWndPageItems[EDT_NO_TAG_MESSAGE] = ::CreateWindowEx(WS_EX_CLIENTEDGE | WS_EX_TRANSPARENT, WC_EDIT, SettingManager->sTexts[SETTXT_NO_TAG_MSG], WS_CHILD | WS_VISIBLE |
        ES_AUTOHSCROLL, 17, 279, 413, 18, m_hWnd, (HMENU)EDT_NO_TAG_MESSAGE, g_hInstance, NULL);
    ::SendMessage(hWndPageItems[EDT_NO_TAG_MESSAGE], EM_SETLIMITTEXT, 256, 0);

    hWndPageItems[GB_NO_TAG_REDIRECT] = ::CreateWindowEx(WS_EX_TRANSPARENT, WC_BUTTON, LanguageManager->sTexts[LAN_REDIRECT_ADDRESS], WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS |
        WS_CLIPCHILDREN | BS_GROUPBOX, 10, 304, 427, 40, m_hWnd, NULL, g_hInstance, NULL);

    hWndPageItems[EDT_NO_TAG_REDIRECT] = ::CreateWindowEx(WS_EX_CLIENTEDGE | WS_EX_TRANSPARENT, WC_EDIT, SettingManager->sTexts[SETTXT_NO_TAG_REDIR_ADDRESS],
        WS_CHILD | WS_VISIBLE | ES_AUTOHSCROLL, 17, 319, 413, 18, m_hWnd, (HMENU)EDT_NO_TAG_REDIRECT, g_hInstance, NULL);
    ::SendMessage(hWndPageItems[EDT_NO_TAG_REDIRECT], EM_SETLIMITTEXT, 256, 0);

    hWndPageItems[BTN_REPORT_SUSPICIOUS_TAG] = ::CreateWindowEx(0, WC_BUTTON, LanguageManager->sTexts[LAN_REPORT_BAD_TAGS], WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,
        7, 355, 433, 16, m_hWnd, NULL, g_hInstance, NULL);
