...
const char* LangStr[] = {
    ...
    "If given address is hostname then resolve to IP address (needed for setting below)",
    ...
    "Move script down",
    "Check syntax",
    "Check syntax of edited script",
    "Restart scripts",
    "Restart all scripts from script directory",
    "Load",
    "Load script into editor",
    "Save",
    "Save script into file",
    ...
    "Report to Operators when bad password is received 3 times for registered user",
    "Enable advanced password protection",
    "Send user on login his ip with UserIP command (client use it to set up active mode)",
    "Accept description tag from uknown client when is valid",
    "Check if user send correct ip in protocol command (DDOS protection)",
    ...
    "No $|<>:?*\"/\\ and <space> in NickName!", 
    "No $ | and <space> in Password!", 
    "User is already registered!", 
    "User with same nick already exist!", 
    "Error in script", 
    ...
    "Bans", 
    "Range bans", 
    "Are you sure that you want to potentialy allow usage of users on this hub to DDOS attack ?", 
    "Settings saved.", 
    "Open in external editor", 
    "Delete script", 
    "Refresh scripts", 
    "Popup scripts window on script error", 
    "Update check", 
    ...
    "Nov", 
    "Dec", 
    "Full ban on IP disallow all users from that IP to login.", 
